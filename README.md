This project is to replicate a blackjack game using only 1 suit. Additional suits can be added using a key (suit), value (card value) pair instead of just the card value. 
